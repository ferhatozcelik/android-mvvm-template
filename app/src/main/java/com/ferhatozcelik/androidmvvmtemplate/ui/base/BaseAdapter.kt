...
abstract class BaseAdapter<VB : ViewBinding, M>(private val bindingFactory: (LayoutInflater, ViewGroup?, Boolean) -> VB, private val list: List<M>, private val itemClickListener: ItemClickListener) : RecyclerView.Adapter<BaseAdapter.BaseViewHolder<VB>>() {
